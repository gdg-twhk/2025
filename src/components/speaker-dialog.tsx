  ...
  return (
    <Dialog>
      ...
      <DialogTrigger asChild>
        ...
        <Card className="pt-0 pb-2 cursor-pointer hover:scale-[1.02] transition-transform bg-gradient-to-b from-zinc-900/60 to-black text-white">
          ...
          <div className="p-4">
            ...
            <p className="mt-1 text-xs text-gray-400 line-clamp-2">{speaker.sessions[0].name}</p>
          </div>
        </Card>
      </DialogTrigger>
      ...
      <DialogContent className="max-w-lg bg-zinc-950/90 backdrop-blur-md border multi-border  text-white">
        ...
        <div className="mt-4 text-sm leading-relaxed space-y-2">
          ...
          <div className="border-t border-zinc-800 pt-3">
            <h4 className="text-sm font-semibold text-purple-300">Talk</h4>
            <p className="text-gray-300">{speaker.sessions[0].name}</p>
          </div>
        </div>
      </DialogContent>
    </Dialog>
